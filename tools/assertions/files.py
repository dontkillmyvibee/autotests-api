...
def assert_get_file_with_incorrect_file_id_response(actual: ValidationErrorResponseSchema):
    """
    Проверяет, что ответ API при запросе файла с некорректным идентификатором содержит ожидаемую ошибку валидации.

    :param actual: Фактический ответ API с ошибкой валидации.
    :raises AssertionError: Если структура или содержание ошибки не соответствуют ожиданию.
    """
